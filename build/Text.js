...
var Text = function Text(_ref) {
  var theme = _ref.theme,
      ...
      props = _objectWithoutProperties(_ref, ["theme", "margin", "padding", "border", "color", "background", "width", "contrast", "children"]);
  ...
  padding = (0, _Container.compilePadding)(theme.spacing, _objectSpread(_objectSpread({}, _primitiveUiSpec.Container.normalizePadding(theme.text.padding)), _primitiveUiSpec.Container.normalizePadding(padding)));
