...
import {CountryPickerProps, validateExtraProps} from "@yosmy/ui-spec";
import {Button, BufferList, Container, Flag, Modal, Text, withTheme} from '@yosmy/simple-ui';
...
const CountryPicker = (props) => {
    ...
    useEffect(() => {
        if (props.favorites.length === 1) {
            const newCountry = props.favorites[0];
